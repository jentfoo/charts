...
func main() {
	...
	minuteCandlestickSeriesList := charts.CandlestickSeriesList{{Data: minuteData}}
	fiveMinuteCandlestickSeriesList := charts.CandlestickSeriesList{{Data: fiveMinuteSeries.Data}}
	seriesList := append(
		minuteCandlestickSeriesList.ToGenericSeriesList(),
		fiveMinuteCandlestickSeriesList.ToGenericSeriesList()...,
	)
